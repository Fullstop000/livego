...
## 安装
直接下载编译好的[二进制文件](https://github.com/Fullstop000/livego/releases)后，在命令行中执行。

#### 从源码编译
1. 下载源码 `git clone https://github.com/Fullstop000/livego.git`
...
### [和 flv.js 搭配使用](https://github.com/Fullstop000/blog/issues/3)
